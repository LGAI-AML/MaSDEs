...
class temporal_privacy_fcns(nn.Module):
    def __init__(self, args):
        ...
        # self.bottleneck_diffusion = nn.Linear(self.args.hidden_dim, self.args.D)
        ...
        nums, _ = temporal_privacy(self.args.c_gap, self.args.r_gap, self.args.T_p)
